...
router.put('/menu/cambiaclave', putcambiaClave); //router.get('/regiones', getRegiones);
//Manejo de Usuarios

router.get('/menu/users', getUsers);
router.post('/menu/users', postUsers);
router.put('/menu/users', putUsers);
router.get('/menu/users/select', getesas); //Manejo de esas

router.get('/menu/esas', getAllesas);
router.post('/menu/esas', postesas);
router.get('/menu/esas/select', getSistemas);
router.delete('menu/esas', deleteesas); //Manejo Secuencias
...
router.get('/menu/secuencias/select', getesas); //Manejo de tipos de Productos

router.get('/menu/tproductos', getTproductos);
router.post('/menu/tproductos', posttProductos);
router.delete('/menu/tproductos', deletetproductos); //Manejo de Productos
...
router.delete('/menu/productos', deleteProductos); //Manejo de Proveedores
...
router.get('/menu/proveedores/comunas', getComunas); // Manejo compras
...
router.post('/menu/compras', postOpecompras); // Manejo ventas
...
router.post('/menu/ventas', postOpeventas); // Manejo de operaciones

router.get('/menu/opgestion', getOperacionesdia);
router.get('/menu/opgestion/detalle', getOpedetalledia);
router.delete('/menu/opgestion', deleteOperaciones); //Consultas

router.get('/menu/qstock', getStock);
router.get('/menu/qproductos', getProductos); //Inicio y Fin de dia

router.get('/menu/inicio', getFechasistema);
router.post('/menu/inicio', postFechasdia);
router.post('/menu/fin', postFindia); //Inicio y Fin de dia
